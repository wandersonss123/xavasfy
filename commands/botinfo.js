...
module.exports = {
  ...
  run: function (client, message, args) {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .addField(':alarm_clock: Estou online há', moment().to(client.startTime, true))
      .addField(':tada: Criado em', formatDate('DD/MM/YYYY, às HH:mm:ss', date))
      .addField(":gear: Bot desenvolvido por","Xavas#1744" )
